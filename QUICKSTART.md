...
### 1. Basic Chat Interface (Recommended for First Run)
...
- Smart input with mode detection
- Command and mention system
...
### 2. Enhanced Version (Full Features)
...
- See message counter in header

### 3. Development Mode (Auto-reload)

```bash
# Basic version with hot reload
bun run dev
...
- **`src/index.tsx`** - Basic chat interface (start here)
- **`src/enhanced.tsx`** - Advanced features + command palette
- **`examples/api-integration.tsx`** - Real API integration
- **`ARCHITECTURE.md`** - Detailed technical documentation
- **`examples/README.md`** - API integration guide
