...
This release introduces workflow mode with Agent Framework integration, enhanced bridge backend streaming, and numerous quality-of-life improvements for agent traceability and workflow artifact management.
...
- Added `AGENTS.md`, `docs/API-INTEGRATION.md`, `docs/bridge/SETUP.md`, and `docs/bridge/CLI-WIRING.md` covering Agent Framework setup and CLI wiring

## Contributors

Thanks to everyone who contributed to this release. Special thanks to core team members and all community testers!
